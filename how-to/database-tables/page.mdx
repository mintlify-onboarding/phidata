...
description: Phidata templates come pre-configured with [SqlAlchemy](https://www.sqlalchemy.org) and [alembic](https://alembic.sqlalchemy.org/en/latest/) to manage databases. The general workflow to add a table is:
---
